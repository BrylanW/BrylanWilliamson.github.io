...
## Overview
This project was developed as part of the CYBR-2600 Cyber Security & Network Practicum course at Hocking College. It simulates a real-world consulting engagement in which a team performs an accessibility audit for a public-sector client.

The goal of this project is to identify accessibility barriers, evaluate user impact, and produce professional documentation aligned with WCAG 2.1 Level AA standards.
...
This project reflects how accessibility, compliance, and risk analysis are performed in professional cybersecurity, IT governance, and public-sector consulting roles.
...
These issues were prioritized based on user impact and the importance of accessing public information.
